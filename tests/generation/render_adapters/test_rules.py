...
def test_rules():
    ...
    # hailuo pulled from routing (BUG-011) — restore to first position when the
    # executor maps per-model CLI params.
    assert rules.route("impossible_physics") == ["seedance_2_0", "veo3_1"]
